...
// After reading 1/3 to 1/2 of the way through this journal, I realized there were many missed typos/mistakes, so I stopped and read the last half and proofed it and then corrected it in the online editor. But I didn't go back and read the first half of the journal and proofed better, so there are plenty of things that were missed, I'm sure... (My reputation as an proofreader is on the line here!! So if you find bunches of mistakes, just know I didn't go through that section!)